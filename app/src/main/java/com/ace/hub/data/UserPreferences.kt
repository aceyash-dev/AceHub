...
class UserPreferences(context: Context) {
    ...
    var showBatteryStats: Boolean
        get() = prefs.getBoolean("show_battery_stats", true)
        set(value) = prefs.edit().putBoolean("show_battery_stats", value).apply()

    var vibrationOnLaunch: Boolean
        get() = prefs.getBoolean("vibration_on_launch", false)
        set(value) = prefs.edit().putBoolean("vibration_on_launch", value).apply()

    var autoDnd: Boolean
        get() = prefs.getBoolean("auto_dnd", false)
        set(value) = prefs.edit().putBoolean("auto_dnd", value).apply()
